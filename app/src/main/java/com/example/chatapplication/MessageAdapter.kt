...
class MessageAdapter(private val context: Context, private val messageList: ArrayList<Message>) :
    ...
    private val defaultProfile = R.drawable.profile_icon // Default profile image
    ...
    /**
     * Loads and displays the sender's profile image, or a default image if none is available.
     */
